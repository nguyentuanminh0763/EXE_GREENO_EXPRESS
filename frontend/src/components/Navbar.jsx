  ...
  return (
    <div className="bg-[#FCF8EF] px-40 py-4 flex justify-between items-center shadow-md rounded-md">
      ...
      <nav className="hidden md:flex gap-10 font-medium text-gray-800">
        ...
        <NavLink to="/about"   className={({ isActive }) => isActive ? activeClass : normalClass}>Tin Tức</NavLink>
        ...
        <NavLink to="/news"    className={({ isActive }) => isActive ? activeClass : normalClass}>Về chúng tôi</NavLink>
