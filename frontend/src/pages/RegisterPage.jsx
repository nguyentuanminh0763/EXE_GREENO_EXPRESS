...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#E9FFF2]">
      <div className="w-full max-w-xl p-6 md:p-12 bg-[#FFF9F0] rounded-2xl shadow-xl">
        {/* Left Illustration */}
...
.
            ...
            <button
              ...
              className="bg-green-500 hover:bg-green-600 text-white font-semibold rounded-lg py-3 disabled:opacity-50 transition"
            >
